...
import static fynn.opencl.InfoUtil.*;
...
public class Mandelbrot {
    ...
    static {
        try {
             source = FileUtil.readFromFile("fynn/opencl/sumKernel.c");
    ...
    public Mandelbrot(long platform, CLCapabilities platformCaps, CLGLInteropDemo.GLFWWindow window, int deviceType, boolean debugGL, int maxIterations) {
    ...
    private void buildProgram() {
        ...
        clProgram = clCreateProgramWithSource(clContext, source, errcode_ret);
        checkCLError(errcode_ret);
